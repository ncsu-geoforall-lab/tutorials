...
# Add titles and labels
plt.title('Sample Depth vs. Time (minutes)')
plt.xlabel('Time')
plt.ylabel('Depth')
...
* [Eath Observation Data Access Gateway (EODAG)](https://eodag.readthedocs.io/en/stable/) add-on currently in development by Google summer of code student.
